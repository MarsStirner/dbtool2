...
class Main(DBToolBaseNode):
    name = 'tmis-1189'
    depends = ['tmis-1189.amb-card', 'tmis-1189.ca-addcolumns', 'tmis-1189.rbattach_chage']
    ...
    def upgrade(cls):
        with cls.connection as c:
            c.execute(u'''
                ...
                ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='Амбулаторная карта';
          ''')
